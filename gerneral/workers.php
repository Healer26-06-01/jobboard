        ...
        <div class="col-md-4">
          <div class="card" style="width: 18rem;">
            <img class="card-img-top" style="height:200px"
              src="<?php echo APPURL; ?>/users/user-images/<?php echo $worker->img; ?>" alt="<?php echo $worker->img; ?>">
            <div class="card-body">
              <h5 class="card-title">
                <?php echo $worker->username; ?>
              </h5>
              <p class="card-text">
                <?php echo substr($worker->bio, 0, 50); ?>
              </p>
              <a target="_blank" href="<?php echo APPURL; ?>/users/public-profile.php?id=<?php echo $worker->id; ?>"
