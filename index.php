      ...
      <div class="col-md-12">
        ...
        <form method="post" action="search.php" class="search-jobs-form">
          <div class="row mb-5">
            ...
            <div class="col-12 col-sm-6 col-md-6 col-lg-3 mb-4 mb-lg-0">
              <select name="job-region" class="selectpicker" data-style="btn-white btn-lg" data-width="100%"
...
<section class="py-5 bg-image overlay-primary fixed overlay" id="next"
  style="background-image: url('<?php echo APPURL; ?>/images/hero_1.jpg');">
  <div class="container">
  ...
  <div class="container">
    ...
    <div class="row align-items-center">
      ...
      <div class="col-6 col-lg-3 col-md-6 text-center">
        <img src="<?php echo APPURL; ?>/images/logo_mailchimp.svg" alt="Image" class="img-fluid logo-1">
      </div>
      <div class="col-6 col-lg-3 col-md-6 text-center">
        <img src="<?php echo APPURL; ?>/images/logo_paypal.svg" alt="Image" class="img-fluid logo-2">
      </div>
      <div class="col-6 col-lg-3 col-md-6 text-center">
        <img src="<?php echo APPURL; ?>/images/logo_stripe.svg" alt="Image" class="img-fluid logo-3">
      </div>
      <div class="col-6 col-lg-3 col-md-6 text-center">
        <img src="<?php echo APPURL; ?>/images/logo_visa.svg" alt="Image" class="img-fluid logo-4">
      </div>

      <div class="col-6 col-lg-3 col-md-6 text-center">
        <img src="<?php echo APPURL; ?>/images/logo_apple.svg" alt="Image" class="img-fluid logo-5">
      </div>
      <div class="col-6 col-lg-3 col-md-6 text-center">
        <img src="<?php echo APPURL; ?>/images/logo_tinder.svg" alt="Image" class="img-fluid logo-6">
      </div>
      <div class="col-6 col-lg-3 col-md-6 text-center">
        <img src="<?php echo APPURL; ?>/images/logo_sony.svg" alt="Image" class="img-fluid logo-7">
      </div>
      <div class="col-6 col-lg-3 col-md-6 text-center">
        <img src="<?php echo APPURL; ?>/images/logo_airbnb.svg" alt="Image" class="img-fluid logo-8">
      </div>
    </div>
  </div>
</section>
  ...
  <div class="owl-carousel single-carousel">
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-6 align-self-end text-center text-lg-right">
          <img src="<?php echo APPURL; ?>/images/person_transparent_2.png" alt="Image" class="img-fluid mb-0">
        </div>
      </div>
    </div>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-6 align-self-end text-center text-lg-right">
          <img src="<?php echo APPURL; ?>/images/person_transparent.png" alt="Image" class="img-fluid mb-0">
        </div>
      </div>
    </div>
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-6 ml-auto align-self-end">
        <img src="<?php echo APPURL; ?>/images/apps.png" alt="Free Website Template by Free-Template.co"
          class="img-fluid">
      </div>
    </div>
  </div>
