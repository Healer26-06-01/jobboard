  ...
  <div class="container">
    <div class="row align-items-center mb-5">
        ...
        <div class="d-flex align-items-center">
          <div class="border p-2 d-inline-block mr-3 rounded">
            <img style="width: 100px; height:100px; margin-bottom:10px"
              src="<?php echo APPURL; ?>/users/user-images/<?php echo $row->company_image; ?>" alt="Image">
          </div>
          <div>
            <h2>
              <?php echo $row->job_title; ?>
      ...
      <div class="row">
        <div class="col-lg-8">
          <div class="mb-5">
            <figure class="mb-5"><img src="<?php echo APPURL; ?>/images/job_single_img_1.jpg" alt="Image"
          ...
          <div class="mb-5">
            ...
            <ul class="list-unstyled m-0 p-0">
              <li class="d-flex align-items-start mb-2"><span class="icon-check_circle mr-2 text-muted"></span><span>
                  <?php echo $row->education_experience; ?>
                </span></li>
    ...
    <div class="row mb-5 justify-content-center">
      <div class="col-md-7 text-center">
        <h2 class="section-title mb-2">
          <?php echo $job_num->job_count; ?> Related Jobs
        </h2>
      </div>
    </div>
      ...
      <?php foreach ($related_job as $job): ?>
        <li class="job-listing d-block d-sm-flex pb-3 pb-sm-0 align-items-center">
          ...
          <div class="job-listing-logo">
            <img src="<?php echo APPURL; ?>/users/user-images/<?php echo $job->company_image; ?>" alt="Image"
              class="img-fluid">
          </div>
