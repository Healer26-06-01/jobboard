        ...
        <form action="update-profile.php?upd_id=<?php echo $id; ?>" method="POST" enctype="multipart/form-data"
          ...
          <div class="row form-group">
            <div class="col-md-12">
              ...
              <textarea name="bio" id="" name="bio" cols="30" rows="7" class="form-control"
                placeholder="Write your notes or questions here..."><?php echo $row->bio; ?></textarea>
            </div>
          </div>
          ...
          <div class="row form-group">
            ...
            <div class="col-md-12">
              ...
              <input type="subject" name="facebook" value="<?php echo $row->facebook; ?>" id="subject"
                class="form-control">
            </div>
          </div>
          ...
          <div class="row form-group">
            ...
            <div class="col-md-12">
              ...
              <input type="subject" name="twitter" value="<?php echo $row->twitter; ?>" id="subject"
                class="form-control">
            </div>
          </div>
          ...
          <div class="row form-group">
            ...
            <div class="col-md-12">
              ...
              <input type="subject" name="linkedin" value="<?php echo $row->twitter; ?>" id="subject"
                class="form-control">
            </div>
          </div>
